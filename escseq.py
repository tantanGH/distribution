...
# cursor backward + highlighted cyan
print("\x1b[50D" + "\x1b[35m" + "Cursor backward!", end="")
time.sleep(1)

# cursor forward + highlighted yellow
print("\x1b[40C" + "\x1b[36m" + "Cursor forward!", end="")
time.sleep(1)

# direct cursor addressing + reversed highlighted cyan
print("\x1b[12;0H" + "\x1b[45m" + "Jump here.", end="")
time.sleep(1)

# reset + clear from cursor to end of screen + reversed highlighted yellow
