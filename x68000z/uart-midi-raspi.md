...
なお、ZMUSIC/RCDが直接SCC/UARTを制御して通信を行うため、Human68k上での SWITCH.X や SPEED.X による RS232C 設定は不要。
...
- [X68Z_RSMIDI_20230420.XDF](https://github.com/tantanGH/distribution/raw/main/x68000z/xdf/X68Z_RSMIDI_20230420.XDF)
...
- [rcd_z2.zip](https://github.com/tantanGH/distribution/raw/main/x68000z/archives/rcd_z2.zip) ... RCD.X 3.01q+z2 RS-MIDIモードを X68000Z UART で動作させるパッチ (tantan)
...
- 2023/04/20 ... SCC割り込みベクタの戻しに失敗していた問題を修正 3.01q+z2
