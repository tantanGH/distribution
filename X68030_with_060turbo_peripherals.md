...
SX-Windowは全く使わないので、自分がX68030でマウスを使う機会はとても少ないです。でも入手した実機についていた純正トラックボールマウスのボールはひび割れてしまっており、まともに使えないのも困るので、細田美装さんのボールを購入させて頂きました。
...
3Dプリンタもすごいですが、きっちりと設計データを作られて材質も吟味されて、手間が掛かっている感じがあります！

<img src='images/tilt_stand.jpeg'/>

左が純正の足、右がましろん版の足となりましたが、ガタ付きもなくバッチリです。
